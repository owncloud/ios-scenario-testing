...
public class FileListPage extends CommonPage {
    ...
    public void openSpacesList() {
        ...
        waitByXpath("//XCUIElementTypeCell[@name=\"Spaces\"]");
        waitById("square.grid.2x2");
        waitByXpath("//XCUIElementTypeStaticText[@name=\"Spaces\"]");
        findXpath("//XCUIElementTypeCell[@name=\"Spaces\"]").click();
    }
    ...
    public boolean displayedList(String path, ArrayList<OCFile> listServer) {
        ...
        for (OCFile ocfile : listServer) {
            ...
            if (ocfile.getName().equalsIgnoreCase(utils.LocProperties.getProperties().getProperty("userNameDefault")) ||
